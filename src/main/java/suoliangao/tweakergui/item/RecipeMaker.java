...
public class RecipeMaker extends Item {
	...
	public EnumActionResult onItemUseFirst(EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, EnumHand hand) {
		...
		if(!world.isRemote && player.isSneaking()) {
			...
			else if (world.getBlockState(pos).getBlock().equals(Blocks.FURNACE) || world.getBlockState(pos).getBlock().equals(Blocks.LIT_FURNACE)) {
				player.openGui(TweakerGUI.instance, GuiHandler.FURNACE, world, pos.getX(), pos.getY(), pos.getZ());
			} else {
